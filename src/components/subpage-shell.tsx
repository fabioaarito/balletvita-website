    ...
    <main className="min-h-screen bg-white">
      ...
      <div className={isYellow ? "bg-[#f6e449]" : "bg-[#67c4a8]"}>
        <div className="relative mx-auto max-w-[402px] lg:max-w-7xl px-[30px] lg:px-8">
          <div className="h-[190px] lg:h-[220px] flex items-end pb-[24px] lg:pb-8">
            <h1
              className={`font-changa text-[26px] lg:text-[40px] font-bold text-center leading-[30px] lg:leading-[48px] ${
